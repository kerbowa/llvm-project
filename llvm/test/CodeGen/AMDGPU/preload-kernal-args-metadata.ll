...
; NO-PRELOAD-SAME: (ptr addrspace(1) inreg [[IN:%.*]], ptr addrspace(1) [[IN1:%.*]], ptr addrspace(1) inreg [[OUT:%.*]], ptr addrspace(1) inreg [[OUT1:%.*]]) #[[ATTR0]] !preload_kernel_args !1 {
...
; NO-PRELOAD: !0 = !{}
; NO-PRELOAD-NEXT: !1 = !{!2}
; NO-PRELOAD-NEXT: !2 = !{i32 0, i32 2}

; PRELOAD-1: !0 = !{!1}
; PRELOAD-1-NEXT: !1 = !{i32 0, i32 2}
; PRELOAD-1-NEXT: !2 = !{}
; PRELOAD-1-NEXT: !3 = !{!4}
; PRELOAD-1-NEXT: !4 = !{i32 0, i32 1}

; PRELOAD-3: !0 = !{!1, !2}
; PRELOAD-3-NEXT: !1 = !{i32 0, i32 2}
; PRELOAD-3-NEXT: !2 = !{i32 1, i32 2}
; PRELOAD-3-NEXT: !3 = !{}
; PRELOAD-3-NEXT: !4 = !{!1, !2, !5}
; PRELOAD-3-NEXT: !5 = !{i32 2, i32 2}
; PRELOAD-3-NEXT: !6 = !{!1, !2, !5, !7}
; PRELOAD-3-NEXT: !7 = !{i32 3, i32 2}
; PRELOAD-3-NEXT: !8 = !{!9, !2, !5}
; PRELOAD-3-NEXT: !9 = !{i32 0, i32 1}

; PRELOAD-8: !0 = !{!1, !2}
; PRELOAD-8-NEXT: !1 = !{i32 0, i32 2}
; PRELOAD-8-NEXT: !2 = !{i32 1, i32 2}
; PRELOAD-8-NEXT: !3 = !{}
; PRELOAD-8-NEXT: !4 = !{!1, !2, !5, !6}
; PRELOAD-8-NEXT: !5 = !{i32 2, i32 2}
; PRELOAD-8-NEXT: !6 = !{i32 3, i32 2}
; PRELOAD-8-NEXT: !7 = !{!1, !2, !5, !6, !8}
; PRELOAD-8-NEXT: !8 = !{i32 4, i32 2}
; PRELOAD-8-NEXT: !9 = !{!10, !2, !5, !6}
; PRELOAD-8-NEXT: !10 = !{i32 0, i32 1}
; PRELOAD-8-NEXT: !11 = !{!10, !12, !5}
; PRELOAD-8-NEXT: !12 = !{i32 1, i32 1}
